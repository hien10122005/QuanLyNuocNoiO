            ...
            private void btnTimKiem_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(cboNam.Text))
                        query += " AND h.Nam = " + cboNam.Text.Trim();
        ...
        private void btnInHD_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(strCon))
                {
                    ...
                    string sqltt = "UPDATE HoaDon SET TrangThai = N'Đã thanh toán' WHERE MaHD = @MaHD";
                    SqlCommand cmd = new SqlCommand(sqltt, con);
            ...
            {
                MessageBox.Show("Đã xảy ra lỗi khi chuẩn bị in hóa đơn: " + ex.Message,
